...
export class ProfileService implements Resolve<any> {
    ...
    getAbout(id: number): Promise<any[]> {
        return new Promise((resolve, reject) => {
            this._httpClient.get("http://localhost:3000/user/" + id).subscribe(
                (data: any) => {
                    this._user = data;
            ...
            this._httpClient
                ...
                .subscribe(
                    ...
                    (reject) => {
                        ...
                        else this.toastr.error(reject.message, "ERREUR");
                    }
                );
        });
    }
        ...
        return new Promise((resolve, reject) => {
            this._httpClient
                ...
                .subscribe(
                    () => {
                        this.toastr.info(
                            "Le mot de passe est bien réinitialiser"
                        );
                        resolve(null);
                    },
                    (reject) => {
            ...
            this._httpClient
                ...
                .subscribe(
                    (data: any) => {
                        ...
                        this.toastr.info(
                            "L'image est bien modifier, rafraichit la page pour appliquer les modification dans tout l'application"
                        );
                        this.aboutOnChanged.next(this._user);
                        resolve(this._user);
                    },
